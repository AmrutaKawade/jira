...
module.exports.processInstallation = (app, queues) => {
  ...
  async function getEnhancedGitHub(installationId, githubHost) {
    const github = await app.auth(installationId);
    enhanceOctokit(github, app.log, { githubHost, gitHubInstallationId: installationId });
  ...
  return async function (job) {
    ...
    const github = await getEnhancedGitHub(installationId, subscription.githubHost);
